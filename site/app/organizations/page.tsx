      ...
      <section className="border-b border-border bg-surface py-12">
        <div className="page-container">
          <SectionHeading
            ...
            description="Every roadmap item records the organizations proposing, owning, or stewarding the work, so attribution stays visible as the project evolves."
          />
        </div>
      </section>
              ...
              <div className="grid gap-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.5fr)]">
                ...
                <div className="rounded-xl border border-border bg-slate-50 p-4">
                  <div className="mb-4 flex items-center justify-between gap-3">
                    <h3 className="text-sm font-bold uppercase tracking-normal text-slate-500">Items proposed or owned</h3>
                    <span
