...
export function SectionHeading({ eyebrow, title, description, action, className = "", as = "h2" }: SectionHeadingProps) {
  const Heading = as;
  ...
  return (
    <div className={`flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between ${className}`}>
      <div className="max-w-3xl">
        ...
        <Heading className="mt-2 text-2xl font-bold leading-tight text-openhw-navy sm:text-3xl">{title}</Heading>
